...
describe("CurrencyConverterTransactionService", () => {
    ...
    describe("createCurrencyConverterTransaction", () => {
        it("should call repository with correct transaction data", async () => {
            ...
            expect(mockRepository.insertCurrencyConverterTransaction)
                .toHaveBeenCalledWith(mockTransactionData);
        });
        ...
        it("should propagate repository errors", async () => {
            ...
            await expect(service.createCurrencyConverterTransaction(mockTransactionData))
